package io.ljunggren.reportGenerator.excel;
...
import io.ljunggren.reportGenerator.Record;
import io.ljunggren.reportGenerator.TestPojo;
...
public class ExcelGeneratorTest {
	...
	public void generateTest() {
        ...
        assertEquals("Application", headers.getCell(3).getStringCellValue());
		assertEquals("Touch Date", headers.getCell(4).getStringCellValue());
        ...
        assertEquals("Report Generator", row1.getCell(3).getStringCellValue());
		assertEquals("2020-06-28", row1.getCell(4).getStringCellValue());
        ...
        assertEquals("Report Generator", row2.getCell(3).getStringCellValue());
		assertEquals("2020-06-28", row2.getCell(4).getStringCellValue());
	}
